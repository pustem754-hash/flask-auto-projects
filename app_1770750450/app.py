...
@app.route('/')
def index():
    h = """<!DOCTYPE html><html lang="ru"><head><meta charset="UTF-8"><title>Блог ЖКХ с постами и комментариями</title>
...
<h1>📝 Блог ЖКХ с постами и комментариями</h1><h2>Новый пост</h2><form method="POST" action="/add">
